...
func (r *NotesyncItemPostgres) GetById(userId, itemId int) (notesync.NotesyncItem, error) {
	var item notesync.NotesyncItem
...
func (r *NotesyncItemPostgres) Delete(userId, itemId int) error {
...
func (r *NotesyncItemPostgres) Update(userId, itemId int, input notesync.UpdateItemInput) error {
	...
	query := fmt.Sprintf(`UPDATE %s ti SET %s FROM %s li, %s ul
		...
		notesyncItemsTable, setQuery, listsItemsTable, usersListsTable, argId, argId+1)
